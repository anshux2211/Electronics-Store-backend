...
I have developed this REST API for an Electronics Store using Spring Boot. This API performs all the fundamental CRUD operations of any e-commerce platform with user validation at every step. The API documentation is available via Swagger.
