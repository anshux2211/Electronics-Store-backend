...
public class ProductControllers {
    ...
    //create
    @PostMapping("/save")
    @Operation(description = "This API is accessible to ADMIN. Creates a new product in the system using the details provided in the request body. It returns the created product with an HTTP 201 status.")
    ...
    @Operation(description = "This API is accessible to ADMIN. This API updates an existing product identified by productId with the new details provided in the request body. Returns the updated product.")
    ...
    @Operation(description = "This API is accessible to ADMIN only. Deletes the product identified by productId from the system. Returns a success message upon successful deletion.")
    ...
    @Operation(description = "This is a public API. Retrieves and returns the details of a single product identified by productId.")
    ...
    //Get All product
    @GetMapping
    @Operation(description = "This is a public API. Fetches all products in a paginated and sorted format, with optional parameters for page number, page size, sorting field, and sort direction")
    ...
    @GetMapping("/stock")
    @Operation(description = "This is a public API. Retrieves all available (in-stock) products in a paginated and sorted manner, similar to the general product listing API.")
    ...
    // Search Product
    @GetMapping("/search")
    @Operation(description = "This is a public API. Searches for products based on a partial or full name match. Supports pagination and sorting for the result set.")
    ...
    @Operation(description = "This is a public API. Fetches all products belonging to a specified brand name, with pagination and sorting options.")
    ...
    @GetMapping("/range")
    @Operation(description = "This is a public API. Returns products that fall within the specified price range (minPrice to maxPrice) and supports pagination and sorting.")
    ...
    @Operation(description = "This API is accessible to ADMIN. Uploads and associates an image file with the specified product. Updates the product's image name and returns an upload confirmation.")
    ...
    @Operation(description = "This is a public API. Downloads the image associated with the product identified by productId. Returns the image file as a response stream.")
    ...
    @Operation(description = "This API is accessible to ADMIN only. Creates a new product and directly associates it with a category specified by categoryID.")
    ...
    @Operation(description = "This API is accessible to ADMIN. Assigns an existing product to a category using their respective IDs. Returns the updated product.")
    ...
    @Operation(description = "This is a public API. Fetches all products associated with a particular category in a paginated format based on categoryId.\n" +
            "\n")
